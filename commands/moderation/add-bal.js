...
module.exports = {
    ...
    run: async function (message, args) {
        ...
        return message.reply(`Added **${amount}** to ${member}'s balance, they now have **${message.client.config.economy.symbol.front}${data.wallet}${message.client.config.economy.symbol.back}**`)
    }
}